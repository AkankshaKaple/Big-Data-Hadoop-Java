...
public class SortByDeptDriver implements Tool {
	...
	public int run(String[] args) throws Exception {
		...
		groupByDeptJob.setMapperClass(SortByDeptMapper.class);
		...
		groupByDeptJob.setReducerClass(SortByDeptReducer.class);
	...
	public static void main(String[] args) throws Exception {
		...
		SortByDeptDriver genderCountDriver = new SortByDeptDriver();
